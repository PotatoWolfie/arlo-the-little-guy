...
public class StrawHatArmorRenderer implements ArmorRenderer {
    private static final Identifier TEXTURE = Identifier.of("arlo-the-little-guy", "textures/models/armor/straw_hat.png");
    ...
    public void render(MatrixStack matrices, OrderedRenderCommandQueue queue, ItemStack stack,
        ...
        if (this.model == null) {
            this.model = new StrawHatModel(
                    MinecraftClient.getInstance().getLoadedEntityModels().getModelPart(ModEntityModelLayers.STRAW_HAT)
            );
        }
