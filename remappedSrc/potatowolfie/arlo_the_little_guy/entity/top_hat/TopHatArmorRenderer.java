...
public class TopHatArmorRenderer implements ArmorRenderer {
    private static final Identifier TEXTURE = Identifier.of("arlo-the-little-guy", "textures/models/armor/top_hat.png");
    ...
    public void render(MatrixStack matrices, OrderedRenderCommandQueue queue, ItemStack stack,
        ...
        if (this.model == null) {
            this.model = new TopHatModel(
                    MinecraftClient.getInstance().getLoadedEntityModels().getModelPart(ModEntityModelLayers.TOP_HAT)
            );
        }
