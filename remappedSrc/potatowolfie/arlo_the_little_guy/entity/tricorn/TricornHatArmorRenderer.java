...
public class TricornHatArmorRenderer implements ArmorRenderer {
    private static final Identifier TEXTURE = Identifier.of("arlo-the-little-guy", "textures/models/armor/tricorn.png");
    ...
    public void render(MatrixStack matrices, OrderedRenderCommandQueue queue, ItemStack stack,
        ...
        if (this.model == null) {
            this.model = new TricornHatModel(
                    MinecraftClient.getInstance().getLoadedEntityModels().getModelPart(ModEntityModelLayers.TRICORN)
            );
        }
