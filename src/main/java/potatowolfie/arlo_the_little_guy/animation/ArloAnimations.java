...
public class ArloAnimations {
	public static final AnimationDefinition ARLO_SHAKE = AnimationDefinition.Builder.withLength(1.0F)
			.addAnimation("arlo", new AnimationChannel(AnimationChannel.Targets.ROTATION,
	...
	public static final AnimationDefinition ARLO_IDLE = AnimationDefinition.Builder.withLength(1.0F).looping()
			.addAnimation("arlo", new AnimationChannel(AnimationChannel.Targets.ROTATION,
	...
	public static final AnimationDefinition ARLO_WIGGLE = AnimationDefinition.Builder.withLength(1.0F)
			.addAnimation("arlo", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.2083F, KeyframeAnimations.degreeVec(0.0F, -1.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.4167F, KeyframeAnimations.degreeVec(0.0F, -3.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.5417F, KeyframeAnimations.degreeVec(0.0F, -2.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
