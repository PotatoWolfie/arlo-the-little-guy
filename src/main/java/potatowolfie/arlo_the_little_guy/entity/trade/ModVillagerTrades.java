package potatowolfie.arlo_the_little_guy.entity.trade;
...
public class ModVillagerTrades {
    ...
    public static final ResourceKey<VillagerTrade> FARMER_4_STRAW_HAT = resourceKey("farmer_4_straw_hat");
    public static final ResourceKey<VillagerTrade> LEATHERWORKER_5_COWBOY_HAT = resourceKey("leatherworker_5_cowboy_hat");
    public static final ResourceKey<VillagerTrade> FISHERMAN_5_TRICORN = resourceKey("fisherman_5_tricorn");

    public static final ResourceKey<VillagerTrade> WANDERING_TRADER_CROWN = resourceKey("wandering_trader_crown");
    ...
    public static void bootstrap(BootstrapContext<VillagerTrade> context) {
        ...
        register(context, FARMER_4_STRAW_HAT, new VillagerTrade(
                ...
                5, 2, 0.05F, Optional.empty(), List.of()
        ));
        ...
        register(context, WANDERING_TRADER_CROWN, new VillagerTrade(
                ...
                1, 5, 0.05F, Optional.empty(), List.of()
        ));
    }
