...
public class PrismarinePipisArmorRenderer implements ArmorRenderer {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath("arlo-the-little-guy", "textures/models/armor/prismarine_pipis.png");
    private PrismarinePipisModel model;
    ...
    public void render(PoseStack matrices, SubmitNodeCollector queue, ItemStack stack,
        ...
        if (this.model == null) {
            this.model = new PrismarinePipisModel(
                    Minecraft.getInstance().getEntityModels().bakeLayer(ModEntityModelLayers.PRISMARINE_PIPIS)
            );
        }
